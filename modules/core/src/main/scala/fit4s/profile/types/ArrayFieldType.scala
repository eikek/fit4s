...
object ArrayFieldType:
  ...
  def codec(
    ...
    }).asInstanceOf[Codec[ArrayFieldType[?]]]
  ...
  object LongArray:
    def unapply(f: ArrayFieldType[?]): Option[Nel[Long]] =
  ...
  object FloatArray:
    def unapply(f: ArrayFieldType[?]): Option[Nel[Double]] =
      f.rawValue.head match
  ...
  object StringArray:
    def unapply(f: ArrayFieldType[?]): Option[Nel[String]] =
      f.rawValue.head match
