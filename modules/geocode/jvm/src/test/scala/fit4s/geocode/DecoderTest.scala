...
class DecoderTest extends FunSuite with NominatimDecoder {
  ...
  test("decode optional fields in Address") {
    ...
    assertEquals(decoded, Address.empty.copy(road = "Strasse".some, city = "Winterthur".some))
  }

  test("decode address") {
    val jsonStr = """{"house_number":"2A","road":"Am Strasse","neighbourhood":"Neudorf","suburb":"Rout","city_district":"Kernstadt","town":"Teilingen","municipality":"Teilingen","county":"Landkreis","state":"Thüringen","ISO3166-2-lvl4":"DE-TH","postcode":"84654","country":"Deutschland","country_code":"de"} """
