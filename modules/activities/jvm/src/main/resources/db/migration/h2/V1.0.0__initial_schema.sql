...
create table "tag"(
  "id" bigint default next value for "tag_id_seq" not null primary key ,
...
-- LOCATION
create sequence "activity_location_id_seq" start with 1;
create table "activity_location"(
  "id" bigint default next value for "activity_location_id_seq" not null primary key,
...
create table "activity"(
  "id" bigint default next value for "activity_id_seq" not null primary key,
...
-- ACTIVITY-SESSION
create sequence "activity_session_id_seq" start with 1;
create table "activity_session"(
  "id" bigint default next value for "activity_session_id_seq" not null primary key,
...
-- ACTIVITY-LAP
create sequence "activity_lap_id_seq" start with 1;
create table "activity_lap"(
  "id" bigint default next value for "activity_lap_id_seq" not null primary key,
...
create sequence "activity_session_data_id_seq" start with 1;
create table "activity_session_data"(
  "id" bigint default next value for "activity_session_data_id_seq" not null primary key,
...
-- TAG-ACTIVITY
create sequence "activity_tag_id_seq" start with 1;
create table "activity_tag"(
  "id" bigint default next value for "activity_tag_id_seq" not null primary key,
...
-- ACTIVITY_STRAVA
create sequence "activity_strava_id_seq" start with 1;
create table "activity_strava"(
  "id" bigint default next value for "activity_strava_id_seq" not null primary key,
  "activity_id" bigint not null,
...
-- GEOPLACE
create sequence "geo_place_id_seq" start with 1;
create table "geo_place"(
  "id" bigint default next value for "geo_place_id_seq" not null primary key,
...
-- activity place
create sequence "activity_geo_place_id_seq" start with 1;
create table "activity_geo_place" (
  "id" bigint default next value for "activity_geo_place_id_seq" not null primary key,
...
-- strava token
create sequence "strava_token_id_seq" start with 1;
create table "strava_token"(
  "id" bigint default next value for "strava_token_id_seq" not null primary key,
